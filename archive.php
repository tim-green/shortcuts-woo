	...
	<div class="container">
					...
					?>
						<article class="article-card <?php echo $is_featured ? 'article-card--featured' : ''; ?>">
							...
							<div class="article-body">
								...
								<a href="<?php the_permalink(); ?>" class="article-link"><?php esc_html_e('Read More', 'shortcuts'); ?>
		...
		<?php else : ?>
			<div class="content-card">
				<p><?php esc_html_e('No posts found.', 'shortcuts'); ?></p>
